...
<html lang="en">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatablesSimple" class="table table-striped table-bordered" style="width: 100%;">
                                        ...
                                        <tbody>
                                             <?php
                                                $ambilsemuadatastock = mysqli_query($conn, "SELECT m.idmasuk, m.tanggal, s.namaobat, m.qty, m.keterangan 
                                                                                            FROM masuk m
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="post">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="editLabel<?= $idmasuk; ?>">Edit Data Masuk</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="qtyMasuk" class="form-label">Quantity</label>
                                                                            <input type="number" name="qty" value="<?= $qty; ?>" class="form-control" required>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="keteranganMasuk" class="form-label">Keterangan</label>
                                                    ...
                                                    <div class="modal fade" id="delete<?= $idmasuk; ?>" tabindex="-1" aria-labelledby="deleteLabel<?= $idmasuk; ?>" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form method="post">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="deleteLabel<?= $idmasuk; ?>">Hapus Data Masuk</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <input type="hidden" name="idmasuk" value="<?= $idmasuk; ?>">
                                                                        Apakah Anda yakin ingin menghapus data masuk untuk obat <strong><?= $namaobat; ?></strong>?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                                        <button type="submit" class="btn btn-danger" name="deleteMasuk">Hapus</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Tambah Obat Masuk</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
    ...
    <div class="modal-body">
        <div class="mb-3">
            ...
            <select name="obatnya" class="form-control" required>
                ...
                while ($fetcharray = mysqli_fetch_array($ambilsemuadatanya)) {
                    $namaobat = $fetcharray['namaobat']; // Pastikan nama kolom benar
                    $idobat = $fetcharray['idbarang']; // Pastikan nama kolom benar
                ?>
        ...
        <br> -->
        <input type="number" name="qty" id="stock" placeholder="Obat Masuk" class="form-control" required>
        <br>
        <div class="mb-3">
